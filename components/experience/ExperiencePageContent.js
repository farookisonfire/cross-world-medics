  ...
  return (
    <div>
      ...
      <div className="text-container">
        ...
        <p>You will be shadowing a healthcare professional suited to your chosen discipline (e.g. doctor, nurse). Generally you will spend 5-8 hours a day in the clinical setting from Monday - Thursday, with a half day on Friday to allow you to optimize your weekend excursions. Hospital and Clinical schedules do change depending on physician availability and demand, so it is possible that your schedule may change slightly or that you may shadow more than one physician. Cross World Medics puts in the added effort to try and match you to the rotation of your choice; however, we do not guarantee specific specialty placements.</p>
